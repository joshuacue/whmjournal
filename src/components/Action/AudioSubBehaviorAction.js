...
export default class AudioSubBehaviorAction extends Component {
  constructor() {
    super();
    this.state = {
      value: '',
  ...
  pressedKey(item) {
    //User.setRecord(Bird.BIRD_NON_LETHAL, item); TODO set record audio
    switch (item) {
      case 'BIRD_SCARING_CARTRIDGE':
      case 'MISSED_SHOTGUN_CARTRIDGE':
      case 'MISSED_RIFLE_ROUND':
      case 'BLANK_ROUND':
        this.props.navigation.navigate(DialerClass.AUDIO_ACTION_NAME);
        break;
      default:
        this.props.navigation.navigate(ActionClass.AUDIO_AIRFIELD_NAME);
        break;
    }
              ...
              <TouchableHighlight
                ...
                onPress={() => {
                  this.props.navigation.navigate(
                    ActionClass.AUDIO_AIRFIELD_NAME,
                  );
                }}>
                <Image
                  style={styles.icons}
