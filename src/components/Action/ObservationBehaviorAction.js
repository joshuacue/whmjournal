...
export default class ObservationBehaviorAction extends Component {
  constructor() {
    super();
    this.state = {
      value: '',
  ...
  pressedKey(item) {
    //User.setRecord(Bird.BIRD_BEHAVIOR, item); TODO record observation
    switch (item) {
      case 'FLYING OVER':
        this.props.navigation.navigate(ActionClass.OBSERVATION_LOCATION_NAME);
        break;
      default:
