...
export default class AudioLocationAction extends Component {
  constructor() {
    super();
    this.state = {
      value: '',
  ...
  pressedKey(item) {
    //User.setRecord(Bird.BIRD_HEADING,item); TODO record audio
    this.props.navigation.navigate(MapClass.AUDIO_CLEAR_NAME);
  }
  pressIn() {
    timer = setInterval(() => {
      pressLen++;
