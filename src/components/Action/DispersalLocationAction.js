...
export default class DispersalLocationAction extends Component {
  constructor() {
    super();
    this.state = {
      value: '',
  ...
  pressedKey(item) {
    //User.setRecord(Bird.BIRD_HEADING,item); TODO set record dispersal
    this.props.navigation.navigate(TimerClass.DISPERSAL_NAME);
  }
  pressIn() {
    timer = setInterval(() => {
      pressLen++;
              ...
              <TouchableHighlight
                ...
                onPress={() => {
                  this.props.navigation.navigate(
                    ActionClass.DISPERSAL_AIRFIELD_NAME,
                  );
                }}>
                <Image
                  style={styles.icons}
