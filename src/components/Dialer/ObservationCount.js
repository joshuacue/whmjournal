...
export default class ObservationCount extends Component {
  constructor() {
    super();
    this.state = {
      value: '',
  ...
  pressedValue() {
    if (this.state.value.length > 0) {
      this.setState({isLoading: true}, () => {
        setTimeout(() => {
          //User.setRecord(Bird.BIRD_COUNT, this.state.value); TODO record observation
          this.props.navigation.navigate(ActionClass.OBSERVATION_NAME);
                ...
                <TouchableHighlight
                  ...
                  onPress={() => {
                    this.props.navigation.navigate(
                      ListViewClass.OBSERVATION_VIEW_NAME,
                    );
                  }}>
                  <Image
                    style={styles.icons}
