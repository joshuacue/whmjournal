...
export default class AudioCount extends Component {
  constructor() {
    super();
    this.state = {
      value: '',
  ...
  pressedValue() {
    if (this.state.value.length > 0) {
      this.setState({isLoading: true}, () => {
        setTimeout(() => {
          //User.setRecord(Bird.BIRD_COUNT, this.state.value); TODO record audio
          this.props.navigation.navigate(ActionClass.AUDIO_NAME);
                ...
                <TouchableHighlight
                  ...
                  onPress={() => {
                    this.props.navigation.navigate(
                      ListViewClass.AUDIO_BIRD_VIEW_NAME,
                    );
                  }}>
                  <Image
                    style={styles.icons}
