...
export default class DispersalListFavoriteView extends Component {
  constructor(props) {
    super(props);
    this.state = {
      navIndex: 0,
  ...
  handleBackButton() {
    this.props.navigation.navigate(ListViewClass.DISPERSAL_VIEW_NAME);
    return true;
  }
  ...
  selectLetter() {
    this.props.navigation.navigate(ListViewClass.DISPERSAL_LETTER_NAME);
  }
  navLeft() {
