...
export default class AudioListFavoriteView extends Component {
  constructor(props) {
    super(props);
    this.state = {
      navIndex: 0,
  ...
  handleBackButton() {
    this.props.navigation.navigate(ListViewClass.AUDIO_BIRD_VIEW_NAME);
    return true;
  }
  ...
  selectLetter() {
    this.props.navigation.navigate(ListViewClass.AUDIO_BIRD_LETTER_NAME);
  }
  navLeft() {
  ...
  pressOut(item) {
    ...
    if (pressLen > 6) {
      ...
      //     }
      // }
      this.props.navigation.navigate(DialerClass.AUDIO_NAME);
    } else {
