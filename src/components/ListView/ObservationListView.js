...
export default class ObservationListView extends Component {
  constructor(props) {
    super(props);
    this.state = {
      navIndex: 0,
  ...
  handleBackButton() {
    this.props.navigation.navigate(MapClass.OBSERVATION_MAP_NAME);
    return true;
  }
  goBack() {
    this.props.navigation.navigate(MapClass.OBSERVATION_MAP_NAME);
  ...
  goFavorites() {
    this.props.navigation.navigate(
      ListViewClass.OBSERVATION_FAVORITE_VIEW_NAME,
    );
  }
  selectLetter() {
