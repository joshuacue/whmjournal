...
export default class DispersalListView extends Component {
  constructor(props) {
    super(props);
    this.state = {
      navIndex: 0,
  ...
  handleBackButton() {
    this.props.navigation.navigate(MapClass.DISPERSAL_MAP_NAME);
    return true;
  }
  goBack() {
    this.props.navigation.navigate(MapClass.DISPERSAL_MAP_NAME);
  ...
  goFavorites() {
    this.props.navigation.navigate(ListViewClass.DISPERSAL_FAVORITE_VIEW_NAME);
  }
  selectLetter() {
