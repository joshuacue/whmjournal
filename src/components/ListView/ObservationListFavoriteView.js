...
export default class ObservationListFavoriteView extends Component {
  constructor(props) {
    super(props);
    this.state = {
      navIndex: 0,
      data: Bird.getData('Favorite'),
    };
  ...
  handleBackButton() {
    this.props.navigation.navigate(ListViewClass.OBSERVATION_VIEW_NAME);
    return true;
  }
  ...
  selectLetter() {
    this.props.navigation.navigate(ListViewClass.OBSERVATION_LETTER_NAME);
  }
  navLeft() {
  ...
  pressOut(item) {
    ...
    if (pressLen > 6) {
      ...
      //     }
      // }
      this.props.navigation.navigate(DialerClass.OBSERVATION_NAME);
    } else {
      //User.setRecord(Bird.BIRD_RECORD,item); TODO record observation
      this.props.navigation.navigate(DialerClass.OBSERVATION_NAME);
    }
    pressLen = 0;
  }
            ...
            <Row style={{width: '202%'}}>
              <View style={styles.itemNavWrapperContainer}>
                ...
                <TouchableHighlight style={styles.itemNavContainer}>
                  <FontAwesome
                    style={styles.keys}
                    icon={parseIconFromClassName('fa fa-heart')}
                  />
                </TouchableHighlight>
                <TouchableHighlight
                  style={styles.itemNavContainer}
