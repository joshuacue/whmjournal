...
export default class RemainsSpecificListView extends Component {
  constructor(props) {
    super(props);
    this.state = {
      navIndex: 0,
  ...
  goFavorites() {
    this.props.navigation.navigate(
      ListViewClass.REMAINS_SPECIFIC_FAVORITE_VIEW_NAME,
    );
  }
  selectLetter() {
    this.props.navigation.navigate(ListViewClass.REMAINS_SPECIFIC_LETTER_NAME);
  }
  navLeft() {
  ...
  pressOut(item) {
    ...
    if (pressLen > 6) {
      ...
      //     }
      // }
      this.props.navigation.navigate(DialerClass.REMAINS_SPECIFIC_NAME);
    } else {
            ...
            <Row>
              <View style={styles.itemWrapperContainer}>
                <TouchableHighlight
                  ...
                  onPress={() => {
                    this.props.navigation.navigate(
                      ActionClass.REMAINS_SPECIFIC_NAME,
                    );
                  }}>
                  <FontAwesome
                    style={styles.keys}
