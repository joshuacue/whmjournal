...
export default class ObservationTimer extends Component {
  constructor() {
    super();
    this.state = {
      value: '',
  ...
  pressedKey(item) {
    ...
    //User.setRecord(Bird.BIRD_TIME, item); TODO  record observation
    this.props.navigation.navigate(MapClass.OBSERVATION_CLEAR_NAME);
  }
  pressIn() {
    timer = setInterval(() => {
      pressLen++;
  ...
  pressedCustom() {
    this.props.navigation.navigate(DialerClass.OBSERVATION_TIMESTAMP_NAME);
  }
  render() {
    return (
