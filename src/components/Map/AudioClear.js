...
export default class AudioClear extends Component {
  constructor() {
    super();
    this.state = {};
    this.select = this.select.bind(this);
    //API.sendMessage('record',JSON.stringify(User.getRecord())); TODO save audio record
    //.clearRecord(); TODO clear audio
  }
  select() {
