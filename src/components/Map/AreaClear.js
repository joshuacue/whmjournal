...
export default class AreaClear extends Component {
  constructor() {
    super();
    this.state = {};
    this.select = this.select.bind(this);
    API.sendMessage('areaClear', JSON.stringify(User.getAreaClearRecord()));
    User.clearAreaClearRecord();
  }
  select() {
      ...
      <TouchableHighlight onPress={this.select} style={styles.container}>
        <>
          ...
          <View style={styles.message}>
            <Text style={styles.status}>AREA CLEAR</Text>
