...
export default class ObservationClear extends Component {
  constructor() {
    super();
    this.state = {};
    this.select = this.select.bind(this);
    //API.sendMessage('record',JSON.stringify(User.getRecord())); TODO save observation record
    //.clearRecord(); TODO clear observation
  }
  select() {
